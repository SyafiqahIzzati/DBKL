...
if($ada>0){
	...
	if($x==$pass1){		
		...
		if ($y!=$pass2){
			echo ("<script>alert('Username & Password Incorrect. Try Again!');document.location.href='index.php';</script>");
		}
	}
	else{
			echo ("<script>alert('Username & Password Incorrect. Try Again!');document.location.href='index.php';</script>");
	...
	echo ("<script>alert('Login Unsuccesful!');document.location.href='index.php';</script>");
