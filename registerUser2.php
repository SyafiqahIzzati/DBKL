...
if($q == $r){
	...
	echo ("<script>alert('Registration Success');document.location.href='adminIndex.php';</script>");
	$_SESSION['adminID']= $adminID;
	}
	else {
   	echo ("<script>alert('Registration Failed . Try Again..');document.location.href='adminIndex.php';</script>");
	}
